          ...
          {state === 'success' && data && (
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5, delay: 0.2 }} className="space-y-10">
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 border border-gray-200 dark:border-gray-700">
                <FeatureImportanceChart data={data.features} topN={topN} showCumulative={showCum} title={`RF Feature Importances (${data.season})`} />
              </div>
              <div className="grid md:grid-cols-2 gap-6">
                <div className="p-6 bg-white dark:bg-gray-800 rounded-lg shadow border border-gray-200 dark:border-gray-700">
                  ...
                  <ul className="list-disc pl-5 space-y-2 text-sm text-gray-600 dark:text-gray-400">
                    <li><strong>Hohe Wichtigkeit</strong> → Modell trennt stark nach diesem Merkmal (z.B. Preis = Proxy für Qualität).</li>
                ...
                <div className="p-6 bg-white dark:bg-gray-800 rounded-lg shadow border border-gray-200 dark:border-gray-700 text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
                  ...
                  <p>Für die Maturaarbeit reicht diese Übersicht zur transparenten Modellreflexion und zur Ableitung von Verbesserungen (Feature Engineering, Regularisierung).</p>
                </div>
              </div>
            </motion.div>
          )}
