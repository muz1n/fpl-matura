...
<#
.SYNOPSIS
    Komplette Pipeline für Full-Season Backtests mit rf_filled
    
.DESCRIPTION
    Dieser Skript führt folgende Schritte aus:
    1. Generiert RF, MA3, POS Vorhersagen für alle GWs
    2. Generiert rf_filled Vorhersagen
    3. Führt Team-Backtest durch
...
.PARAMETER SkipPredictions
    Überspringe Vorhersage-Generierung (falls bereits vorhanden)
...
Write-Host "Full-Season Pipeline für $Season" -ForegroundColor Cyan
...
if (-not $SkipPredictions) {
    ...
    Write-Host "[SKIP] Vorhersage-Generierung übersprungen" -ForegroundColor Yellow
}
...
# Schritt 3: Team Backtest durchführen
Write-Host ""
Write-Host "========================================" -ForegroundColor Cyan
